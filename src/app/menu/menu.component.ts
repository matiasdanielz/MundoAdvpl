...
export class MenuComponent {
  ...
  categories: Array<string> = ['2017', '2018', '2019', '2020', '2021', '2022'];
  ...
  consumptionPerCapita: Array<PoChartSerie> = [
    { label: '2021', data: [86.5, 51.3, 44.6, 39.5, 27.6, 27.3, 25.4, 21.5, 20.8, 15.9, 15.4, 14.4] },
    { label: '2022', data: [86.1, 52.1, 47.3, 37.8, 29.8, 28.5, 24.9, 22.5, 21.1, 14.5, 15.5, 15.5] }
  ];

  participationByCountryInWorldExports: Array<PoChartSerie> = [
    { label: 'Brazil', data: [350, 322, 254, 269, 383, 313], color: 'color-10' },
    { label: 'Vietnam', data: [125, 174, 263, 119, 252, 168] },
    { label: 'Colombia', data: [238, 537, 635, 9, 110, 121] },
    { label: 'India', data: [541, 536, 531, 344, 215, 115] },
    { label: 'Indonesia', data: [117, 326, 410, 210, 54, 26] }
  ];
